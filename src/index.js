...
//     //helper const newarr = await helperCandle(result)
//     let newarr = [];
...
//         Low: marketpricedata,
//       };
//       await TradeDataMinute.create(data);
//       await TradeDataHour.create(data);
//       await TradeDataDay.create(data);
//     } else {
...
//             Low: marketpricedata,
//           };
//           await TradeDataHour.create(newvalues);
...
//             Low: marketpricedata,
//           };
//           await TradeDataDay.create(newvalues);
